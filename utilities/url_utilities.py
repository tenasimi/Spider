...
# add the code needed to read the text file (with the urls in it)
from bs4 import BeautifulSoup  # Alt + Enter  bu setiri yazacaq bura
...
def load_urls_from_file(file_path: str):
    try:
        ...
        exit(2)  # zadaem return code unsuccessful
...
# analyze the text
def scrape_page(page_contents: str):  # beautifulSoup screen-scraping library istifade etdim
    global word
